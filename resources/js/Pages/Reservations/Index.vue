    ...
    <AppLayout title="Reservations">
                        ...
                        <form @submit.prevent="submit" class="space-y-4 mt-4">
                            <div>
                                ...
                                <select
                                    ...
                                    class="input w-full rounded-md border-gray-300"
                                >
        ...
        <div class="max-w-[85rem] mx-auto my-8 aspect-w-16 aspect-h-7">
                <img
                    ...
                    src="https://cysuites.com/assets/images/staycation_offer.jpeg"
                    alt="Features Image"
                />
            </div>
        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <!-- Table -->
            <div
                class="overflow-x-auto bg-white dark:bg-neutral-800 shadow rounded-xl"
            >
                <table
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                <Badge
                                    ...
                                    class="capitalize text-white px-2"
                                >
                                    {{ res.status }}
                                </Badge>
                            </td>
                            ...
                            >
                                ...
                                <Button
                                    size="sm"
                                    class="flex-1 bg-neutral-800 text-white hover:bg-red-700"
                                    variant="destructive"
